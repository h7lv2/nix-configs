...

{
  ...
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/39cf2f5c-fddb-4434-b5d8-d747ce72313d";
      fsType = "btrfs";
    };

  boot.initrd.luks.devices."dm_crypt".device = "/dev/disk/by-uuid/4a3a8405-730f-466e-b1af-f3a97f525b67";

  fileSystems."/boot" =
    { device = "/dev/disk/by-uuid/6809-66B0";
      fsType = "vfat";
